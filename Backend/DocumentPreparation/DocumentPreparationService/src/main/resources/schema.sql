...
CREATE TABLE dokument (
                          ...
                          status integer,
                          prioritet nvarchar2(255)  CHECK (prioritet IN ('visok', 'srednji', 'mali')),
...
CREATE TABLE revizija_izmena (
                                 ...
                                 izmena varchar(255),
                                 fajl_id integer,
                                 aktivni_fajl_id integer,
                                 ispravljena NUMBER(1) CHECK (ispravljena IN (0,1)),
                                 datum_ispravljanja date,
                                 ispravka_odobrena NUMBER(1) CHECK (ispravka_odobrena IN (0,1))
);
...
CREATE TABLE dokument_aktivni_fajl (
                                       ...
                                       dokument_id integer,
                                       fajl_id integer,
                                       CONSTRAINT dokument_aktivni_fajl_unq  UNIQUE (dokument_id, fajl_id)
);
