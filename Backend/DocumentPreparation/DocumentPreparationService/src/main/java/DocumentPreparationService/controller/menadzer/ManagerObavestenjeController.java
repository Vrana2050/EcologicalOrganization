...
@RestController
@RequestMapping("/api/docPrep/manager/notification")
public class ManagerObavestenjeController extends BaseController<Obavestenje,Long, ObavestenjeDto> {
    @Autowired
    private IObavestenjeService obavestenjeService;
    @Autowired
    private IObavestenjeConverter mapper;
    public ManagerObavestenjeController(IObavestenjeService dokumentService, IObavestenjeConverter  mapper) {
