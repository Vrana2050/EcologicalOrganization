...
@RestController
@RequestMapping("/api/docPrep/manager/status")
public class ManagerStatusController extends BaseController<Status,Long, StatusDto> {
    @Autowired
    private IStatusService statusService;
    @Autowired
    private IStatusConverter mapper;
    public ManagerStatusController(IStatusService dokumentService, IStatusConverter  mapper) {
