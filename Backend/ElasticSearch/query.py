...
def build_elastic_query_documents(request: AdvancedElasticSearchRequest):
    must_clauses = []
        ...
        "highlight": {
            ...
            "fields": {
                "summary": {
                    ...
                    "no_match_size": 150,  # Ako nema matcha, uzmi prvih 150 karaktera
                    "fragmenter": "span"   # Bolje fragmentisanje
                },
                "name": {
...
def build_elastic_query_directories(request: AdvancedElasticSearchRequest):
